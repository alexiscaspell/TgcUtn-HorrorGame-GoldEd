...
namespace Examples.Quake3Loader
{
    ...
    /// La clase BspCollisionManager realiza un chequeo de colsiones con el escenario. Las colisiones soportadas son una versión
    ...
    /// a un equivalente de shader en HLSL de DirectX. Este proceso es experimental, aún está incompleto y los shaders no se 
    ...
    /// Para cargar un escenario es necesario apuntar el mediaPath a la carpeta con todo el contenido gráfico del juego Quake original
    ...
    /// Los escenarios deben ser compilados en GtkRadiant con la opción "Build => Q3Map2 (final) BSP -meta, -vis, -light -fast -filter -super 2 -bounce 8" (ante última)
    ...
    public class EjemploLoadQ3Level : TgcExample
    {
        ...
        {
            return "Permite cargar escenarios de Quake 3 en formato BSP. Utiliza matriz PVS para renderizado y posee detección de colisiones. Presionar L para capturar el mouse. Puede tardar unos minutos en cargar.";
        }
