...
namespace Examples.PostProcess
{
    ...
    public class EfectoOndas : TgcExample
    {
        ...
        {
            return "Graba la escena a un Render Target y luego con un pixel shader distorsiona la imagen con ondas de senos";
        }
        ...
        private void drawPostProcess(Device d3dDevice)
        {
            ...
            effect.SetValue("ondas_vertical_length", (float)GuiController.Instance.Modifiers["wave_length"]);
            effect.SetValue("ondas_size", (float)GuiController.Instance.Modifiers["wave_size"]);
