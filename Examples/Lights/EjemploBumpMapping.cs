...
namespace Examples.Lights
{
    ...
    /// BumpMapping no usa la normal de cada vértice para iluminar, sino que utiliza una textura auxiliar denominada NormalMap.
    /// El NormalMap es una textura que cada pixel RGB corresponde a un vector normal (XYZ)
    /// Crear un buen NormalMap para un mesh es una tarea de diseño. Existen herramientas para generar automáticamente un NormalMap
